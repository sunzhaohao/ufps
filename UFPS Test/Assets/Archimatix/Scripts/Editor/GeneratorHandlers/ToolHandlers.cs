...
namespace AX.GeneratorHandlers
{
	...
	{
	/*
		[MenuItem("GameObject/3D Object/Archimatix Nodes/Tools/RepeaterTool")]
		static void InitRepeaterTool() {
			AXEditorUtilities.addNodeToCurrentModel("RepeaterTool");
		}

		[MenuItem("GameObject/3D Object/Archimatix Nodes/Tools/MaterialTool")]
		static void InitMaterialTool() {
			AXEditorUtilities.addNodeToCurrentModel("MaterialTool");
		}
		 
		[MenuItem("GameObject/3D Object/Archimatix Nodes/Tools/PlaneTool")]
		static void InitPlaneTool() {
			AXEditorUtilities.addNodeToCurrentModel("PlaneTool");
		}
		*/
	}
	...
	public class PlaneToolHandler: GeneratorHandler3D 
	{
		...
		public override void drawBoundsHandles(Matrix4x4 consumerM, bool forceDraw=false)
		{
			...
			/*
			Handles.matrix = matrix; // * consumerM * parametricObject.getAxisRotationMatrix() * parametricObject.getLocalAlignMatrix() ;
