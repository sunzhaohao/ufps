...
namespace AX.GeneratorHandlers
{
	...
	public class RadialRepeater2DHandler : GeneratorHandler2D 
	{
		...
		public override void drawControlHandles(ref List<string> visited, Matrix4x4 consumerM, bool beingDrawnFromConsumer)
		{
			...
			RepeaterTool repeaterToolU = (parametricObject.generator as RadialRepeater2D).repeaterToolU;
			...
			if (repeaterToolU != null )
			{
				...
				// ASK RADIYAL_REPEATER_TOOL to DRAW
		...
		public override void drawControlHandlesofInputParametricObjects(ref List<string> visited, Matrix4x4 consumerM)
		{
			...
			RadialRepeater2D gener2D = (generator as RadialRepeater2D);
