...
namespace AX.Generators
{
	...
	public class RepeaterTool : AXTool, ITools
	{
		...
		public override void init_parametricObject() 
		{
			...
			// BAY
			P_Bay = parametricObject.addParameter(AXParameter.DataType.Float, 		bayName, 3f);
			...
			// ACTUAL_BAY
			P_ActualBay = parametricObject.addParameter(AXParameter.DataType.Float,  actualBayName, 3f);
	...
	public class MaterialTool : AXTool, ITools
	{
		...
		public void setTexelsPerUnit()
		{
			...
			if (parametricObject.axMat.mat != null && parametricObject.axMat.mat.mainTexture != null && parametricObject.axTex != null && parametricObject.axTex.scale.x != 0)
			{
		...
		{
			if (parametricObject.axMat.mat != null && parametricObject.axMat.mat.mainTexture != null)
