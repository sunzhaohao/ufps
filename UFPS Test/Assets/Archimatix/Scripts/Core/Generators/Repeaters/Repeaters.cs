...
namespace AX.Generators
{
	...
	public class RepeaterBase : AX.Generators.Generator3D
	{
		...
		public override void initGUIColor ()
		{
			...
			GUIColor 		= new Color(.77f, .77f, 1, .7f);
		...
		public virtual void initializeBays(string pName)
		{
			...
			case "Node Mesh":
				if (repeaterToolU != null)
					repeaterToolU.P_Bay.initiateRipple_setFloatValueFromGUIChange( nodeSrc_p.parametricObject.bounds.size.x*3.5f);
				if (repeaterToolV != null)
					repeaterToolV.P_Bay.initiateRipple_setFloatValueFromGUIChange( nodeSrc_p.parametricObject.bounds.size.z*3.5f);
				break;
			case "Cell Mesh":
				if (repeaterToolU != null)
					repeaterToolU.P_Bay.initiateRipple_setFloatValueFromGUIChange( cellSrc_p.parametricObject.bounds.size.x*3.1f);
				if (repeaterToolV != null)
					repeaterToolV.P_Bay.initiateRipple_setFloatValueFromGUIChange( cellSrc_p.parametricObject.bounds.size.z*3.1f);
				break;
			case "Bay SpanU":
				if (repeaterToolU != null)
					repeaterToolU.P_Bay.initiateRipple_setFloatValueFromGUIChange( spanUSrc_p.parametricObject.bounds.size.x*2.1f);
				if (repeaterToolV != null)
					repeaterToolV.P_Bay.initiateRipple_setFloatValueFromGUIChange( spanUSrc_p.parametricObject.bounds.size.z*2.1f);
				break;
			case "Bay SpanV":
				if (repeaterToolU != null)
					repeaterToolU.P_Bay.initiateRipple_setFloatValueFromGUIChange( spanVSrc_p.parametricObject.bounds.size.x*2.1f);
				if (repeaterToolV != null)
					repeaterToolV.P_Bay.initiateRipple_setFloatValueFromGUIChange( spanVSrc_p.parametricObject.bounds.size.z*2.1f);
				break;
			}
