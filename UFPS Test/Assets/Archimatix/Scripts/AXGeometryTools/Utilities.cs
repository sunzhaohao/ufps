...
//				return true;
		...
		public static  IntPoint CurvePt_2_IntPt(CurvePoint c)
		{
		...
		public static Path curve2Path(List<CurvePoint> curve)
		{ 
			Path path = new Path();
...
//			}
		...
		public static Vector3[] path2Vec3s(Path path, Axis axis)
		{
		...
		public static Matrix4x4 getEndTransformA(Path path)
		{
			...
			Vector2 v = AXGeometryTools.Utilities.IntPt2Vec2(path[0]) - AXGeometryTools.Utilities.IntPt2Vec2(path[1]);
		...
		public static Matrix4x4 getEndTransformB(Path path, bool isBeveled = false)
		{
			...
			Vector2 v = AXGeometryTools.Utilities.IntPt2Vec2(path[path.Count-1]) - AXGeometryTools.Utilities.IntPt2Vec2(path[path.Count-2]);
			Vector2 vp = AXGeometryTools.Utilities.IntPt2Vec2(path[path.Count-2]) - AXGeometryTools.Utilities.IntPt2Vec2(path[path.Count-3]);
